...
public class RPSLSpock {
    ...
    /**
     *
     * @param pick this parameter is for rock,paper,scissors,lizard,spock based on it is pick by the input.
     * @return If the pick equals null it will return false which will do not work and move to another argument.
     */
    ...
    /**
     *
     * @return It has differnt case will based on what is inputed by the user. First the pick which mean there is nothing.
     */
    ...
    /**
     *
     * @param c_pick is the computer pick parameter which is picked by the computer.
     * @param h_pick is picked by the input that is choosen by the user.
     * @return The method will return the computer picks which can be rock, paper, scissor, lizard, spock on a random pick.
     */
